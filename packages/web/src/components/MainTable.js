...
import SortingSelectingToolbar from './tableComponents/SortingSelectingToolbar';
// components
...
export default function MainTable() {
  ...
  return (
    <Card sx={{width: 900}}>
      <TableContainer sx={{width: 800, display: 'flex', alignItems: 'center', textAlign: 'center', justifyContent: 'space-around'}}>
